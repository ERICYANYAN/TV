...
import com.fongmi.android.tv.databinding.OkFragmentVodBinding;
...
public class OKVodFragment extends BaseFragment implements CustomScroller.Callback, VodPresenter.OnClickListener {

    private HashMap<String, String> mExtends;
    private OkFragmentVodBinding mBinding;
    ...
    public static OKVodFragment newInstance(String key, String typeId, Style style, HashMap<String, String> extend, boolean folder) {
        ...
        OKVodFragment fragment = new OKVodFragment();
    ...
    protected ViewBinding getBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        return mBinding = OkFragmentVodBinding.inflate(inflater, container, false);
    }
